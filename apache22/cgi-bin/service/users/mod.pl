...
use librs::basic;
if ($ARGV[0] eq "help")
 { print "Этот модуль обеспечивает изменеие данных о пользователях";
 }
else {
...
print qq{<TR onmouseover="naveli(this)"   onmouseout ="uveli(this)" ><Th><a href="dbase.pl?service=users&cmd=modification&uid=$uid">$username</a></Th><TD>$uid</TD><TD>$gid</TD><TD>$comment</TD><TD>$dir</TD><TD>$shell</TD></TR>};
}
}
elsif($_=~/metka2/){
